...
public class Zero implements Version {
    ...
    static {
        ...
        ENCHANTMENT_MANAGER.register("enchantment.silk_touch", 33, 1, 1, l -> 25, l -> (1 + l * 10) + 50, null);
        ENCHANTMENT_MANAGER.register("enchantment.unbreaking", 34, 5, 3, l -> 5 + (l - 1) * 10, l -> (1 + l * 10) + 50, null);
        ENCHANTMENT_MANAGER.register("enchantment.fortune", 35, 2, 3, l -> 20 + (l - 1) * 12, l -> (1 + l * 10) + 50, null);
        ...
        MATERIAL_MANAGER.register(0, "material.tool.wood", 1);
        MATERIAL_MANAGER.register(1, "material.tool.stone", 5);
        MATERIAL_MANAGER.register(2, "material.tool.iron", 14);
        MATERIAL_MANAGER.register(3, "material.tool.diamond", 12);
        MATERIAL_MANAGER.register(4, "material.tool.gold", 22);
        MATERIAL_MANAGER.register(5, "material.armor.leather", 1);
