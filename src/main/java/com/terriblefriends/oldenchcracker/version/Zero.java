...
class Zero extends Version {
    //Tools for Minecraft version Beta 1.9 Prerelease 4
    ...
    protected Zero() {
        ...
        enchantmentManager.register("enchantment.silk_touch", 33, 1, 1, l -> 25, l -> (1 + l * 10) + 50, null);
        enchantmentManager.register("enchantment.unbreaking", 34, 5, 3, l -> 5 + (l - 1) * 10, l -> (1 + l * 10) + 50, null);
        enchantmentManager.register("enchantment.fortune", 35, 2, 3, l -> 20 + (l - 1) * 12, l -> (1 + l * 10) + 50, null);
        ...
        materialManager.register(0, "material.tool.wood", 1);
        materialManager.register(1, "material.tool.stone", 5);
        materialManager.register(2, "material.tool.iron", 14);
        materialManager.register(3, "material.tool.diamond", 12);
        materialManager.register(4, "material.tool.gold", 22);
        materialManager.register(5, "material.armor.leather", 1);
    ...
    public void reverseExtremes(RandomReverser reverser, int advances, boolean isLow) {
        for (int i = 0; i < (advances * 3)+2; i++) {
            ...
            reverser.consumeNextIntCalls(1, 4);
        ...
        if (isLow) {
            reverser.addNextIntCall(4, 0, 0);
            reverser.addNextIntCall(8, 0, 0);
            reverser.addNextIntCall(5, 0, 0);
        }
        else {
            reverser.addNextIntCall(4, 3, 3);
