...
public class Zero implements Version {
    ...
    static {
        ...
        enchantmentList.register("Silk Touch", 33, 1, 1, l -> 25, l -> (1 + l * 10) + 50, null);
        enchantmentList.register("Unbreaking", 34, 5, 3, l -> 5 + (l - 1) * 10, l -> (1 + l * 10) + 50, null);
        enchantmentList.register("Fortune", 35, 2, 3, l -> 20 + (l - 1) * 12, l -> (1 + l * 10) + 50, null);
        ...
        materials.register("ToolWood", 1);
        materials.register("ToolStone", 5);
        materials.register("ToolIron", 14);
        materials.register("ToolDiamond", 12);
        materials.register("ToolGold", 22);
        materials.register("ArmorLeather", 1);
