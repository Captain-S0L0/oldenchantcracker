...
public class Two implements Version {
    ...
    //Tools for Minecraft versions 1.1 to 12w17a (1.3 snap)
    ...
    static {
        ...
        enchantmentList.register("Power", 48, 10, 5, l -> 1 + (l - 1) * 10, l -> (1 + (l - 1) * 10) + 15, null);
        enchantmentList.register("Punch", 49, 2, 2, l -> 12 + (l - 1) * 20, l -> (12 + (l - 1) * 20) + 25, null);
        enchantmentList.register("Flame", 50, 2, 1, l -> 20, l -> 50, null);
        enchantmentList.register("Infinity", 51, 1, 1, l -> 20, l -> 50, null);
        ...
        itemList.register("Bow", new int[]{48, 49, 50, 51});
        ...
        materials.register("Bow", 1);
        //materials.register("Fishing Rod", 1);
    }
    ...
    public String[] getItems() {
        return new String[] {"Helmet", "Chestplate", "Leggings", "Boots", "Bow", "Sword", "Pickaxe", "Axe", "Shovel"};
    }

    @Override
    public String[] getMaterials() {
        return new String[] {"ToolWood", "ToolStone", "ToolIron", "ToolDiamond", "ToolGold", "ArmorLeather", "ArmorChain", "ArmorIron", "ArmorDiamond", "ArmorGold", "Bow"};
    }
